    ...
    <div class="row">
        <div class="col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li class="active" ><a href="<%=basePath%>fgsindex.do"><span class="sr-only">(current)</span>主页 </a></li>
                <li><a href="<%=basePath%>fgsselect.do">分公司报告查询</a></li>
                <li><a href="<%=basePath%>lyinput.do">分公司报告录入</a></li>
                <li><a href="<%=basePath%>tofgsedit.do">分公司报告编辑</a></li>
            </ul>
