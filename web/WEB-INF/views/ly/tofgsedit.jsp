    ...
    <div class="row">
        <div class="col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="<%=basePath%>tofgsedit.do"><span class="sr-only">(current)</span>查询分公司报告编辑 </a></li>
            </ul>

        </div>
        <div class="col-md-10 col-md-offset-2 main">
            <h1 class="page-header">查询报告编辑</h1><br>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-primary" id="testselect" >报告查询</button>
...
<script>
    ...
    function initTable(){
        $('#tradeList').bootstrapTable({
            url: "<%=path%>/fgsindexajax.do",  //请求后台的URL（*）
            method: 'get',   //请求方式（*）
...
//                }
        ...
        $('#testselect').click(function () {
            $('#tradeList').bootstrapTable('refresh', {url: "<%=path%>/fgsindexajax.do"});
//            $('#tradeList') .bootstrapTable('getAllSelections')
        });

        $('#edit').click(function () {
            var blgid =getIdSelections()
            location.href = "fgsedit.do?bglid="+blgid;

        });
        $('#trave').click(function () {
            var blgid =getIdSelections()
            location.href = "fgstrave.do?bglid="+blgid;
...
//            '</a>'
    ...
    function displaycolor(value,row,index) {
        var a = "";
        if(value == "2") {
            a = '<span style="color:#00ff00">已完成</span>';
        }else if(value == "4") {
            a= '<span style="color:#FF0000">被驳回</span>';
        }
        return a;
    }
    //ACTION的事件监听和处理
