    ...
    <div class="row">
        <div class="col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active" ><a href="#"><span class="sr-only">(current)</span>报告转换</a></li>
            </ul>

        </div>
        <div class="col-md-9 col-md-offset-2 main">
            <br/>
            <h1 class="page-header">报告性质转换</h1>
            <br/>
            <form class="form-inline" action="<%=basePath%>fgstraveedit.do?bglid=${bgl.id}" method="post">
                <div class="row">
                    <div class="col-md-3">
