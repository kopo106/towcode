    ...
    <div class="row">
        <div class="col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active" ><a href="<%=basePath%>input.do"><span class="sr-only">(current)</span>报告编辑</a></li>
            </ul>
        ...
        <div class="col-md-9 col-md-offset-2 main">
            ...
            <form class="form-inline" action="<%=basePath%>traveedit.do?bglid=${bgl.id}" method="post">
                <div class="row">
                    <div class="col-md-3">
