    ...
    <div class="row">
        <div class="col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active" ><a href="<%=basePath%>inputa.do"><span class="sr-only">(current)</span>报告录入</a></li>
            </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="bgnum" class="form-control" id="bgnum" placeholder="正式/预评报告编号">
                        </div>
                    </div>
                    <br/><br/><br>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="laiyuan" class="form-control" id="laiyuan" placeholder="项目来源渠道">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" name="shidian" class="form-control" id="shidian" placeholder="价值时点">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" name="chujudate" class="form-control" id="chujudate" placeholder="报告出具日期">
                        </div>
                    </div>
                    <br/><br/><br>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" data-provide="typeahead" name="zhuanxie" class="form-control" id="zhuanxie" placeholder="撰写报告人">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="jszhuanxie">技术撰写</label>
                            <input type="text" autocomplete="off" data-provide="typeahead" name="jszhuanxie" class="form-control" id="jszhuanxie" placeholder="技术撰写">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" data-provide="typeahead" name="shenhe" class="form-control" id="shenhe" placeholder="审核报告人">
                        </div>
                    </div>
                    <br/><br/><br>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" data-provide="typeahead" name="kancha" class="form-control" id="kancha" placeholder="照片勘察人员">
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label for="shidikc">实地勘察人员</label>
                            <input type="text" autocomplete="off" data-provide="typeahead" name="shidikc" class="form-control" id="shidikc" placeholder="实地勘察人员">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" data-provide="typeahead" name="jiazhigoutong" class="form-control" id="jiazhigoutong" placeholder="价值沟通">
                        </div>
                    </div>
                    <br/><br/><br>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" data-provide="typeahead" name="dingjia" class="form-control" id="dingjia" placeholder="定价人员">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="fuzeren">项目负责人</label>
                            <input type="text" autocomplete="off" data-provide="typeahead" name="fuzeren" class="form-control" id="fuzeren" placeholder="项目负责人">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text"  name="gujiashi" class="form-control" id="gujiashi" placeholder="估价师">
                        </div>
                    </div>
                    <br><br><br>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="tel" class="form-control" id="tel" placeholder="报告联系人电话">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="memo" class="form-control" id="memo" placeholder="备注">
                        </div>
                    </div>
                    <br><br><br>
