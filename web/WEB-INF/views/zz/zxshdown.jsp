    ...
    <div class="row">
        <div class="col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="<%=basePath%>select.do"><span class="sr-only">(current)</span>查询下载</a></li>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for = select>下载选项</label>
                            <select  id="select" class="form-control">
                                <option value="all">-------------------------</option>
                                <option value="zxorjszx">撰写人/技术撰写人</option>
                                <option value="zporsd">照片勘察/实地勘察</option>
                                <option value="shdown">报告审核</option>
                                <option value="jzdown">价值沟通</option>
                                <option value="djdown">报告定价</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-5" >
...
<script>
    ...
    function initTable(){
        $('#tradeList').bootstrapTable({
            url: "<%=path%>/zxshdownajax.do",  //请求后台的URL（*）
            method: 'get',   //请求方式（*）
...
//            }
        ...
        $('#testselect').click(function () {
            $('#tradeList').bootstrapTable('refresh', {url: "<%=path%>/zxshdownajax.do"});
        });
