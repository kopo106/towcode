    ...
    <div class="row">
        <div class="col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active" ><a href="#"><span class="sr-only">(current)</span>分公司报告审核</a></li>
            </ul>

        </div>
        <div class="col-md-9 col-md-offset-2 main">
            <br/>
            <h1 class="page-header">分公司报告审核</h1>
            <br/>
            <form class="form-inline" action="<%=basePath%>fgsshenheedit.do?fgsbglid=${bgl.id}" method="post">
                <div class="row">
                    <div class="col-md-3">
