    ...
    <div class="row">
        <div class="col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="<%=basePath%>fgsshe.do"><span class="sr-only">(current)</span>查询分公司报告编辑 </a></li>
            </ul>

        </div>
        <div class="col-md-10 col-md-offset-2 main">
            <h1 class="page-header">分公司报告审核</h1><br>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            <input type="hidden" id = bumen value="<%=loginuser.getBumen()%>" />
                            <label for = startdate>开始日期</label>
                            <input type="date" class="form-control"  id="startdate"/>
                            <label for = enddate>截止日期</label>
                            <input type="date" class="form-control"  id="enddate"/>
                            <button type="button" class="btn btn-primary" id="testselect" >分公司报告查询</button>
                            <button type="button" class="btn btn-success" id="fgssh" >分公司报告编辑</button>
                            <button type="button" class="btn btn-success" id="fgsback" >分公司报告退回</button>
...
<script>
    ...
    function initTable(){
        $('#tradeList').bootstrapTable({
            url: "<%=path%>/fgsshajax.do",  //请求后台的URL（*）
            method: 'get',   //请求方式（*）
...
//                },
        ...
        $('#testselect').click(function () {
            $('#tradeList').bootstrapTable('refresh', {url: "<%=path%>/fgsshajax.do"});
        });

        $('#fgssh').click(function () {
            var blgid =getIdSelections()
            location.href = "fgsshinput.do?bglid="+blgid;

        });
        $('#fgsback').click(function () {
            var blgid =getIdSelections()
            location.href = "fgsback.do?bglid="+blgid;
