                    ...
                    <form class="form-inline">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <select id="baogaotype" name="baogaotype" class="form-control">
                                    <option>----</option>
                                    <option>预评报告</option>
                                    <option>正式报告</option>
                                </select>
                                ...
                                <input type="button" class="form-control" id = "testselect" name="testselect" value="查询">
                        ...
                        <br>
                        <div id="maina" style="width: 1200px;height:550px;"></div>
                        <br>
                        <div id="tables">
...
<script>
    ...
    function initTable(){
        ...
        $('#tradeList').bootstrapTable({
            url: "<%=path%>/statisticsajxaa.do",  //请求后台的URL（*）
            method: 'get',   //请求方式（*）
...
//            }
        ...
        $('#testselect').click(function () {
            $('#tradeList').bootstrapTable('refresh', {url: "<%=path%>/statisticsajxaa.do"});
            $.ajax({
                type : "POST",  //提交方式
                url : "<%=basePath%>tubiaoajax.do",//路径
                data : {
                    bumen: $("#bumen").val(),
                    year: $("#year").val(),
                    month: $("#month").val(),
