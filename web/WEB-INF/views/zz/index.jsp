    ...
    <div class="row">
        <div class="col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li class="active" ><a href="<%=basePath%>index.do"><span class="sr-only">(current)</span>主页 </a></li>
                <%--<li><a href="<%=basePath%>bgtoedit.do">报告编辑</a></li>--%>
                <% if(loginuser.getBumen().equals("技术部")) {%>
                <li><a href="<%=basePath%>input.do">报告录入</a></li>
                <li><a href="<%=basePath%>select.do">报告查询/编辑/转换/二维码</a></li>
                <li><a href="<%=basePath%>fgsshenhe.do">分公司报告审核</a></li>
                <li><a href="<%=basePath%>fgsshselect.do">分公司审核查询</a></li>
                <li><a href="<%=basePath%>zxshdown.do">查询下载</a></li>
                <li><a href="<%=basePath%>jsbewmlist.do">二维码登记信息</a></li>
                <%--<li><a href="<%=basePath%>bguploadinput.do">预评报告上传</a></li>--%>
                <li><a href="<%=basePath%>inputupfile.do">预评报告上传</a></li>
                <%--<li><a href="<%=basePath%>statistics.do">统计</a></li>--%>

                <%}else if(loginuser.getBumen().equals("洛阳")==false){%>
                <li><a href="<%=basePath%>inputa.do" >报告录入一</a></li>
                <%}%>

                <li><a href="<%=basePath%>statisticsa.do">工作量统计</a></li>
        ...
        <div class="col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header">预评查询登记系统</h1><br>
            <br><br>
        </div>
