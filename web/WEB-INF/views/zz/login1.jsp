...
<div class="container">
    ...
    <form class="form-signin" action="<%=basePath%>logindo.do" method="post">
        <h2 class="form-signin-heading">请输入帐户名和密码</h2><br><br>
        <label for="loginname" class="sr-only">用户名</label>
        <input type="text" id="loginname" name="loginname" class="form-control" placeholder="输入用户名" required autofocus>
