    ...
    <div class="row">
        <div class="col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="#">分公司报告驳回</a></li>
            </ul>

        </div>
        <div class="col-md-9 col-md-offset-2 main">
            <br/>
            <h1 class="page-header">分公司报告驳回</h1>
            <br/>

            <form class="form-horizontal" action="<%=basePath%>fgsbackfix.do" method="post">
                <div class="form-group">
                    <label for="backmemo" class="col-md-2 control-label">报告驳回说明</label>
                    <div class="col-md-6">
                        <textarea id="backmemo" name="backmemo" class="form-control" rows="4"></textarea>
                        <input type="hidden" name="bglid" value="${bglid}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-6">
                        <button type="submit" class="btn btn-default">提交说明</button>
