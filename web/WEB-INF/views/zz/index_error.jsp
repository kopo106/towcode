    ...
    <div class="row">
        <div class="col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li class="active"><a href="<%=basePath%>index.do"><span class="sr-only">(current)</span>报告查询 </a></li>

                <% if(loginuser.getBumen().equals("技术部")) {%>
                <li><a href="<%=basePath%>input.do">报告录入</a></li>
                <%}else{%>
                <li><a href="<%=basePath%>inputa.do" >报告录入</a></li>
                <%}%>
                <li><a href="<%=basePath%>statistics.do">工作量统计</a></li>
            </ul>

        </div>
        <div class="col-md-10 col-md-offset-2 main">
            <p class="text-right"><%=loginuser.getUsername()%>----<%=loginuser.getBumen()%></p>
