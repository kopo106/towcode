    ...
    <div class="subnavbar-inner">
        <div class="container">
            <ul class="mainnav">
                ...
                <li class="active"><a href="<%=basePath%>ewmbglist.do"><i class="icon-facetime-video"></i><span>登记系统转换</span></a></li>
                                            ...
                                            <div class="row">
                                                <div class="span10">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-success" id="edit" >添加二维码</button>
