...
public class CreateQRCode2 {
    public void QRcode(String key,String path) throws IOException {
...
//        String qrData = "http://qrcode.baiandma.top:6007/jsb/yanzheng.do?key="+key;//内容信息
        String qrData = "http://qrcode.baiandma.top:6006/jsb/yanzheng.do?key="+key;//内容信息
